...
<body onload="check2(${check})">
		...
		<div class="row px-xl-5">
			<div class="col-12">
				<nav class="breadcrumb bg-light mb-30">
					<a class="breadcrumb-item text-dark" href="/index">Page home</a> <a
					...
					<form action="/shop/detail/${sessionScope.cateId}"
						...
						<div class="d-flex align-items-center mb-4 pt-2">
							...
							<button type="submit" class="btn btn-primary px-3">
								<i class="fa fa-shopping-cart mr-1"></i> Add to Basket
							</button>
							...
							<div class="row">
								<div class="col-md-6">
									<ul class="list-group list-group-flush">
										<li class="list-group-item px-0">Trademark:
											${loadInfo.manufacture.name}</li>
										<li class="list-group-item px-0">Material:
								...
								<div class="col-md-6">
									<ul class="list-group list-group-flush">
										<li class="list-group-item px-0">Origin:
											${loadInfo.origin}</li>
										<li class="list-group-item px-0">Status: In stock</li>
										<li class="list-group-item px-0"></li>
									</ul>
								</div>
							</div>
	...
	<div class="container-fluid py-5">
		<h2
			...
			<span class="bg-secondary pr-3">Explore More</span>
		</h2>
		<div class="row px-xl-5">
			<div class="col">
