				...
				<div class="col-md-3">
					<div class="nav flex-column nav-pills" role="tablist"
						...
						<a class="nav-link active" id="orders-nav"
							...
							class="fa fa-shopping-bag"></i>Order</a> <a class="nav-link"
							id="payment-nav" data-toggle="pill" href="#payment-tab"
							role="tab"><i class="fa fa-credit-card"></i>
							Payment methods</a> <a class="nav-link ${check==2?'active':''}" id="address-nav"
							...
							href="#account-tab" role="tab"><i class="fa fa-user"></i>Personal information</a> <a class="nav-link" href="/logout"><i
									...
									<tbody>
										<c:forEach var="item" items="${order}">
											<tr>
												...
												<td>${item.status?'Delivered':'Awaiting'}</td>
												<td><a href="/shop/invoice/${item.name}"
													class="btn btn1 ">Bill</a> <a
													href="/shop/order/delete/${item.name}"
													class="btn btn1 ${item.status?'disabled':''}">Cancel</a></td>
											</tr>
										</c:forEach>
									</tbody>
								</table>
						...
						<div class="tab-pane fade ${check==2?'show active':''}"
							...
							<form:form action="/shop/profile/update"
								...
								<div class="row">
									...
									<div class="col-md-12">
										<button formaction="/shop/profile/update/user" class="btn btn1">Update</button>
										<br> <br>
									</div>
								</div>
