					...
					<div class="col-lg-6 d-none d-lg-block">
						<div class="p-5">
							<div class="text-center">
								<img class="" alt="" src="/user/img/login1.jpg">
							</div>
						</div>
					</div>
					<div class="col-lg-6">
						<div class="p-5">
								...
								<div class="modal fade" id="exampleModal" tabindex="-1"
									...
									<div class="modal-dialog" style="border-radius: 0;">
										<div class="modal-content" style="border-radius: 0;">
											...
											<div class="modal-body">Password refresh path is
												availablesent via your email. Please check your email!</div>
											<div class="modal-footer">
												...
												<button type="submit" formaction="/register/mailSender"
													class="btn btn-primary" style="border-radius: 0;">Confirm</button>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="text-center">
								<a class="small" href="/login">Do you already have an
									account? Log in!</a>
							</div>
						</div>
					</div>
