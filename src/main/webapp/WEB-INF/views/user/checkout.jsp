			...
			<div class="col-12">
				<nav class="breadcrumb bg-light mb-30">
					<a class="breadcrumb-item text-dark" href="/index">Home Page</a> <span
						class="breadcrumb-item active">Pay</span>
				</nav>
			</div>
		</div>
	</div>
	...
	<form:form action="/shop/checkout" method="post"
		...
		<div class="container-fluid">
			<div class="row px-xl-5">
				...
				<div class="col-lg-4">
					<h5 class="section-title position-relative text-uppercase mb-3">
						<span class="bg-secondary pr-3">Detailed Invoice</span>
					</h5>
					<div class="bg-light p-30 mb-5">
						...
						<div class="border-bottom pt-3 pb-2">
							...
							<div class="d-flex justify-content-between mb-3">
								<h6 class="font-weight-medium">Promotion</h6>
								<h6 class="font-weight-medium">0 $</h6>
							</div>
							<div class="d-flex justify-content-between">
								<h6 class="font-weight-medium">Shipping Fee</h6>
								<h6 class="font-weight-medium">1 $</h6>
							</div>
						</div>
						<div class="pt-2">
					...
					<div class="mb-5">
						<h5 class="section-title position-relative text-uppercase mb-3">
							<span class="bg-secondary pr-3">Pay</span>
						</h5>
						<div class="bg-light p-30">
							<div class="form-group">
								<div class="custom-control custom-radio">
									...
									<label class="custom-control-label" for="directcheck">Cash
									</label>
