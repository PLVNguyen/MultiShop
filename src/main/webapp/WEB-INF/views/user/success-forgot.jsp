							...
							<div class="col-lg-6">
								<div class="p-5">
									<div class="text-center">
										<h1 class="h4 text-gray-900 mb-2">Notification?</h1>
										<p class="mb-4">We've sent you a password reset link
										password to your email. Please check your email to complete!</p>
									</div>
									<form:form class="user">
										<a href="/login"
											class="btn btn-primary btn-user btn-block">Come back log in</a>
									</form:form>
									<hr>
									<div class="text-center">
