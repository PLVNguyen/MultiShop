							...
							<div class="col-lg-6">
								<div class="p-5">
									<div class="text-center">
										<h1 class="h4 text-gray-900 mb-2">Refresh Password?</h1>
										<p class="mb-4">Please enter a new password to refresh the passwordpassword!</p>
									</div>
									<form:form action="" method="post"
										...
										<button type="submit" 
											class="btn btn-primary btn-user btn-block">Save</button>
